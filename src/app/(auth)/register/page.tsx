...
export default function RegisterPage() {
  ...
  const handleDetailsSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Use email as identifier if provided, otherwise use phone
  ...
  const handleSocialRegister = async (provider: 'google' | 'twitter' | 'facebook') => {
    ...
    showLoader(`Signing up with ${provider.charAt(0).toUpperCase() + provider.slice(1)}...`);
    ...
    <div className="min-h-screen bg-white md:bg-gradient-to-br md:from-[#184979]/5 md:via-white md:to-[#f26322]/5 relative overflow-hidden flex items-center justify-center py-6 md:py-12 px-3 md:px-4">
      ...
      <div className="max-w-md w-full relative z-10">
        <div className="text-center mb-4 md:mb-8">
          ...
          <p className="text-gray-600 text-sm md:text-base">Join us and start shopping</p>
        </div>
        ...
        <div className="bg-white md:bg-white/90 backdrop-blur-xl rounded-xl md:rounded-2xl shadow-lg md:shadow-2xl p-4 md:p-8 border border-gray-200 md:border-white/50">
            ...
            <form onSubmit={handleDetailsSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-2 md:py-3 border-2 border-gray-300 rounded-xl focus:border-[#184979] focus:ring-2 focus:ring-[#184979]/20 outline-none transition-all font-semibold text-gray-900 placeholder-gray-400 bg-white text-sm md:text-base"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3 border-2 border-gray-300 rounded-xl focus:border-[#184979] focus:ring-2 focus:ring-[#184979]/20 outline-none transition-all bg-white text-gray-900 placeholder:text-gray-500"
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-3 gap-3">
                ...
                <button
                  ...
                  className="flex items-center justify-center py-3 px-4 border-2 border-gray-300 rounded-xl hover:border-blue-400 hover:bg-blue-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                ...
                <button
                  ...
                  disabled={socialLoading !== null || loading}
                  className="flex items-center justify-center py-3 px-4 border-2 border-gray-300 rounded-xl hover:border-blue-500 hover:bg-blue-50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {socialLoading === 'facebook' ? (
                    <svg className="animate-spin h-5 w-5" style={{ color: '#1877F2' }} fill="none" viewBox="0 0 24 24">
                      <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
                      <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                    </svg>
                  ) : (
          ...
          {step === 'otp' && (
            <form onSubmit={handleOtpSubmit} className="space-y-6">
              <div className="text-center">
                <div className="bg-gradient-to-r from-[#184979]/10 to-[#f26322]/10 border border-[#184979]/30 rounded-lg p-4 mb-4">
                  <div className="flex items-center justify-center gap-2 mb-2">
                    ...
                    <span className="text-sm font-bold text-gray-700">+91 {formData.phone}</span>
                  </div>
                  <p className="text-xs text-gray-600 mb-2">{formData.name}</p>
                  <button
                    type="button"
                    onClick={handleEditDetails}
                    className="text-xs font-bold text-[#f26322] hover:text-[#184979]"
                  >
                    Edit Details
                  </button>
                </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-200 text-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href="/login" className="font-bold text-[#f26322] hover:text-[#184979] transition-colors">
                Login
              </Link>
            </p>
          </div>
